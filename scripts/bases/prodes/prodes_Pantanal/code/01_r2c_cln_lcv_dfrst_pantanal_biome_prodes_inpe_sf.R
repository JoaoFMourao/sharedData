...
output = paste0(root,"\\cleanData\\cln_lcv_dfrst_pantanal_biome_prodes_inpe_sf.Rdata")
...
# COLUMN CLEANUP
# column names
setnames(raw.prodes, "fid",         "prodes_id") # in 2024, not exactly mapping into old "uid"
...
cln.lcv.dfrst.pantanal.biome.prodes.inpe.sf <- raw.prodes
rm(raw.prodes)
...
#summary(cln.lcv.dfrst.pantanal.biome.prodes.inpe.sf)
#View(cln.lcv.dfrst.pantanal.biome.prodes.inpe.sf)
#plot(cln.lcv.dfrst.pantanal.biome.prodes.inpe.sf)
...
save(cln.lcv.dfrst.pantanal.biome.prodes.inpe.sf, file = output)
