...
output = paste0(root,"\\cleanData\\cln_lcv_dfrst_mask_cerrado_biome_prodes_inpe_sf.Rdata")
...
cln.lcv.dfrst.mask.cerrado.biome.prodes.inpe.sf <- raw.prodes
rm(raw.prodes)
...
# summary(cln.lcv.dfrst.mask.cerrado.biome.prodes.inpe.sf)
# View(cln.lcv.dfrst.mask.cerrado.biome.prodes.inpe.sf)
# plot(cln.lcv.dfrst.mask.cerrado.biome.prodes.inpe.sf)
...
save(cln.lcv.dfrst.mask.cerrado.biome.prodes.inpe.sf, file = output)
