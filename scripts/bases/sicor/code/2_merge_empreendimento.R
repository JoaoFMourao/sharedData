...
####    Last updated: Apr 24th, 2024, by: Wagner F. Oliveira                ####
#### ---------------------------------------------------------------------- ####
...
# Load data
sicor_op_basica <- readRDS(paste0(clean, "sicor_main_2013_2024.Rds"))
...
# Save cleaned data
saveRDS(df, paste0(clean, "sicor_main_2013_2024_empreendimento.Rds"))
