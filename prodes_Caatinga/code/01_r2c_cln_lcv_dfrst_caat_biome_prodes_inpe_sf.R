...
output = paste0(root,"\\cleanData\\cln_lcv_dfrst_caat_biome_prodes_inpe_sf.Rdata")
...
cln.lcv.dfrst.caat.biome.prodes.inpe.sf <- raw.prodes
rm(raw.prodes)
...
#summary(cln.lcv.dfrst.caat.biome.prodes.inpe.sf)
#View(cln.lcv.dfrst.caat.biome.prodes.inpe.sf)
#plot(cln.lcv.dfrst.caat.biome.prodes.inpe.sf)
...
save(cln.lcv.dfrst.caat.biome.prodes.inpe.sf, file = output)
