...
work = paste0(root, "\\rawData\\yearly_deforestation.shp")
output = paste0(root,"\\cleanData\\cln_lcv_dfrst_mt_at_biome_prodes_inpe_sf.Rdata")
...
# COLUMN CLEANUP
# column names
setnames(raw.prodes, "fid",         "prodes_id") # in 2021, not exactly mapping into old "uid"
...
cln.lcv.dfrst.mt.at.biome.prodes.inpe.sf <- raw.prodes
rm(raw.prodes)
...
#summary(cln.lcv.dfrst.mt.at.biome.prodes.inpe.sf)
#View(cln.lcv.dfrst.mt.at.biome.prodes.inpe.sf)
#plot(cln.lcv.dfrst.mt.at.biome.prodes.inpe.sf)
...
save(cln.lcv.dfrst.mt.at.biome.prodes.inpe.sf, file = output)
