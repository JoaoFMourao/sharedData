...
# RAW DATA
root = paste0("A:\\land\\prodes_Caatinga") # main directory
work = paste0(root, "\\rawData\\accumulated_deforestation_2000.shp")
output = paste0(root,"\\cleanData\\cln_lcv_dfrst_mask_caatinga_biome_prodes_inpe_sf.Rdata")
...
# COLUMN CLEANUP
# column names
setnames(raw.prodes, "uid",         "prodes_id") # in 2021, not exactly mapping into old "id"
...
cln.lcv.dfrst.mask.caatinga.biome.prodes.inpe.sf <- raw.prodes
rm(raw.prodes)
...
# summary(cln.lcv.dfrst.mask.caatinga.biome.prodes.inpe.sf)
# View(cln.lcv.dfrst.mask.caatinga.biome.prodes.inpe.sf)
# plot(cln.lcv.dfrst.mask.caatinga.biome.prodes.inpe.sf)
...
save(cln.lcv.dfrst.mask.caatinga.biome.prodes.inpe.sf, file = output)
