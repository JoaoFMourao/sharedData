...
# RAW DATA
root = paste0("A:\\land\\prodes_Cerrado") # main directory
work = paste0(root, "\\rawData\\yearly_deforestation.shp")
output = paste0(root,"\\cleanData\\cln_lcv_dfrst_cerrado_biome_prodes_inpe_sf.Rdata")
...
cln.lcv.dfrst.cerrado.biome.prodes.inpe.sf <- raw.prodes
rm(raw.prodes)
...
#summary(cln.lcv.dfrst.cerrado.biome.prodes.inpe.sf)
#View(cln.lcv.dfrst.cerrado.biome.prodes.inpe.sf)
#plot(cln.lcv.dfrst.cerrado.biome.prodes.inpe.sf)
...
save(cln.lcv.dfrst.cerrado.biome.prodes.inpe.sf, file = output)
