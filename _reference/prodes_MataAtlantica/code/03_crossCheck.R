...
defo.biome <- file.path(
  DIR.CPI.DATA,
  "land/prodes_MataAtlantica/cleanData/02_mrg_mataAtlanticaMuni"
)
...
aux.name <- load(
  file.path(
    DIR.CPI.DATA,
    "land",
    "prodes_MataAtlantica\\cleanData",
    "cln_lcv_dfrst_mt_at_biome_prodes_inpe_sf.Rdata"
  )
)
...
write.xlsx(answer,file.path(
  DIR.CPI.DATA,
  "land/prodes_MataAtlantica/cleanData","03_crossCheck.xlsx"))
