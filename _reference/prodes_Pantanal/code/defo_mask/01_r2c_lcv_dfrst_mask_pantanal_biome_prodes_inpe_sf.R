...
# RAW DATA
root = paste0("A:\\land\\prodes_Pantanal") # main directory
work = paste0(root, "\\rawData\\accumulated_deforestation_2000.shp")
output = paste0(root,"\\cleanData\\cln_lcv_dfrst_mask_pantanal_biome_prodes_inpe_sf.Rdata")
...
cln.lcv.dfrst.mask.pantanal.biome.prodes.inpe.sf <- raw.prodes
rm(raw.prodes)
...
# summary(cln.lcv.dfrst.mask.pantanal.biome.prodes.inpe.sf)
# View(cln.lcv.dfrst.mask.pantanal.biome.prodes.inpe.sf)
# plot(cln.lcv.dfrst.mask.pantanal.biome.prodes.inpe.sf)
...
save(cln.lcv.dfrst.mask.pantanal.biome.prodes.inpe.sf, file = output)
