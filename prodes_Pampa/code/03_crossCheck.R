...
defo.biome <- file.path(
  DIR.CPI.DATA,
  "land/prodes_Pampa/cleanData/02_mrg_pampaMuni"
)
...
aux.name <- load(
  file.path(
    DIR.CPI.DATA,
    "land",
    "prodes_Pampa\\cleanData",
    "cln_lcv_dfrst_pampa_biome_prodes_inpe_sf.Rdata"
  )
)
...
write.xlsx(answer,file.path(
  DIR.CPI.DATA,
  "land/prodes_Pampa/cleanData","03_crossCheck.xlsx"))
