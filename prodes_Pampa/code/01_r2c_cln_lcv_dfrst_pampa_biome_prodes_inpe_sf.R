...
output = paste0(root,"\\cleanData\\cln_lcv_dfrst_pampa_biome_prodes_inpe_sf.Rdata")
...
cln.lcv.dfrst.pampa.biome.prodes.inpe.sf <- raw.prodes
rm(raw.prodes)
...
# summary(cln.lcv.dfrst.pampa.biome.prodes.inpe.sf)
#View(cln.lcv.dfrst.pampa.biome.prodes.inpe.sf)
#plot(cln.lcv.dfrst.pampa.biome.prodes.inpe.sf)
...
save(cln.lcv.dfrst.pampa.biome.prodes.inpe.sf, file = output)
